...
/**
 * Enthält den Hauptteil der Logik und kommuniziert sowohl mit dem Model als auch mit der View.
 * 
...
public class Controller
{
	 ...
	 * Konstruktor
	 * 
	 * @param inFile Die Eingabedatei
	 * @param outFile Die Ausgabedatei
	 * @throws FileNotFoundException Falls eine Datei nicht erstellt oder nicht geöffnet werden kann. 
	 */
	...
	/**
	 * Führt das Programm vollständig aus und schreibt das Ergebnis in die Augabe.
	 */
	public void run()
	{
	 ...
	 * 
	 * @param strategy Die auszuführende Strategie
	 * @param point Die aktuelle Parzelle
	 * @param lastDecision Die letzte getroffene Richtungsentscheidung
	...
	private boolean backtrack(Strategy strategy, Point point, int lastDecision)
	{
		...
		if(isValidPoint(point, area))
		{
			...
			if (success == false)
			{
				...
				{
					// wenn alle zellen bis auf die blockierten abgearbeitet wurden
